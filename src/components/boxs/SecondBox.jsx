    ...
    <div className="Second-Box">
      <div className="box-info-section">
        <div className="top-boxs-section">
          <AiFillContainer style={{color:"#8884d8", fontSize:"20px"}} />
          <span>Total Users</span>
        </div>
        <h1>11.235</h1>
        <Link to="/" style={{fontSize:"16px", color:"#8884d8",letterSpacing:"1px"}}>View All</Link>
      </div>
      <div className="box-chart-section">
        ...
        <div className="chart-text-contain">
          <span className="percentage" style={{color:"green"}}>45%</span>
